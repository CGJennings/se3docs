/*
  This file is derived from Microsoft's TypeScript definitions for
  es6. These would normally be excluded from documentation, but
  in this case as many plug-in developers are not experienced
  with JavaScript it is helpful to have this information all in
  one place.

  The goal is to gather all the standard JS definitions into rhino-*
  files, comment out anything not yet included in Strange Rhino,
  and document any language extensions in common.d.ts (or other
...
/*
At least some of this is supported (e.g., String.localeCompare)
but it would need re-arranging as the Intl object doesn't exist.
*/
