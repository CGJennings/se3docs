 ...
 * # diy library
 * 
 * When included in a script by adding `useLibrary("diy")`, that script
 * can then be used to defines a new DIY component. This involves defining
 * functions that will handle key events in the lifecycle of the component
 * as well as registering a class map entry that registers the new
 * component.
 * 
 * For more information, refer to the
 * [developer manual page on DIY components](https://cgjennings.github.io/se3docs/dm-diy.html).
 */
declare module diy {
    ...
    interface DIYScriptFunctions {
        /**
         * Called when the DIY component is first created. This is used to set 
         * up the component's basic features (face style, base key, etc.).
         * This method and onRead are the only places where these values can
         * be changed without throwing an exception.
         * 
        ...
        /**
         * Called to set up any objects needed to paint the component's
         * front face(s).
         * 
         * @param diy the component
         * @param sheet the sheet representing the face in question
         */
        createFrontPainter(diy: DIY, sheet: DIYSheet): void;

        /**
         * Called to paint content on the component's front face(s).
         * 
         * @param g a graphics context to use for drawing
         * @param diy the component
         * @param sheet the sheet representing the face in question
         */
        paintFront(g: JavaObject<"java.awt.Graphics2D">, diy: DIY, sheet: DIYSheet): void;
         ...
         * @param sheet the sheet representing the face in question
         */
        paintBack(g: JavaObject<"java.awt.Graphics2D">, diy: DIY, sheet: DIYSheet): void;
         ...
         * @param sheet the sheet representing the face in question
         */
        createBackPainter(diy: DIY, sheet: DIYSheet): void;
        ...
        /**
         * Called when the component is being written to a file
         * after all regular content has been saved.
         * @param diy the component
         * @param oos a stream that can be used to write custom data to the file
         */
        onWrite(diy: DIY, oos: JavaObject<"ca.cgjennings.io.SEObjectOutputStream">): void;


        /**
         * Called when the component is being read from a file
         * after all regular content has been loaded.
         * @param diy the component
         * @param ois a stream that can be used to read custom data from the file
         */
