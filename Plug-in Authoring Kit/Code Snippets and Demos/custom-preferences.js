/*
 * custom-preferences.js - version 1
 *
 * This example demonstrates one way to add custom components
 * to a custom preferences category. A preferences category
 ...
 * the value. To add a custom control not provided by the
 ...
 *
 * See the Project Examples for other examples of extending
 * and/or implementing Java classes in complex ways from
 * script code. See editor-listeners.js for examples that
 * are less complex and do not require the full use of
 * JavaAdapter.
 */
...
// but this is a handy component for example purposes.
