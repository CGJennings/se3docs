/*
 * tint-presets.js - version 2
 *
 * This script uses a fake game component to demonstrate how to add a list of
...
function paintFront(g, diy, sheet) {
    ...
    g.drawImage(tinted, (sheet.templateWidth - tintable.width) / 2, (sheet.templateHeight - tintable.height) / 2,
        null
    );
