 ...
 * list-items.js
 *
 * A fake game component that demonstrates how to use the ListItem
 * class to control:
...
function createInterface(diy, editor) {
    ...
    let boxItems = [
        ['GREEK_ALPHA', 'Alpha', ImageUtils.getIcon('project://pak-assets/alpha.png')],
        ['GREEK_BETA', 'Beta', ImageUtils.getIcon('project://pak-assets/beta.png')],
        ['GREEK_GAMMA', 'Gamma', ImageUtils.getIcon('project://pak-assets/gamma.png')]
    ];
