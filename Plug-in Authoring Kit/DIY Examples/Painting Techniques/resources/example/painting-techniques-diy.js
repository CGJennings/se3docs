 ...
 *
 * An example DIY card that demonstrates how to achieve various
 * effects in your card painting functions.
 */
...
function createImage() {
	...
	switch( $image ) {
		case 'Fedora':
			...
			break;
		case 'Logo':
			res = 'icons/application/256.png';
			break;
		case 'Octopus':
			res = 'icons/octopus.png';
			break;
		case 'Magnifying Glass':
			res = 'icons/ui/find-lr.png';
			break;
		case 'Strange Coins':
			res = 'portraits/misc-portrait.jp2';
			break;
		case 'Abby':
			res = 'example/abby.jp2';
			break;
		default:
	...
	switch( $texture ) {
		...
		case 'Brushed Gold Texture':
			im = createTexturedImage( im,
				ImageUtils.get( 'example/brushed-gold-texture.jp2', true )
			);
			break;
		case 'Leaf Texture':
			im = createTexturedImage( im,
				ImageUtils.get( 'example/leaf-texture.jp2', true )
			);
			break;
		case 'Leather Texture':
			im = createTexturedImage( im,
				ImageUtils.get( 'example/leather-texture.jp2', true )
			);
			break;
	}
