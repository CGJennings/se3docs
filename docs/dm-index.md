...
4. **Additional plug-in resources (images, fonts, etc.)**
   ...
   5. [Cloud fonts](dm-cloud-fonts.md)
   6. [Class map resources](dm-res-classmap.md)
   7. [Conversion map resources](dm-res-conversionmap.md)
   8. [Settings file resources](dm-res-settings.md)
   9. [String table resources](dm-res-string-table.md)
   10. [Tile set resources](dm-res-tile-set.md)
   11. [Silhouette resources](dm-res-silhouette.md)
   12. [Default abbreviation table resources](dm-res-abbrv-table.md)
   13. [Installation notes and scripts](dm-installation.md)
   14. [Named objects](dm-named-objects.md)
5. **Development tools**
