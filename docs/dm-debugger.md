...
![step out icon](images/debugger/stepout.png) **Step Out**  
...
4. Restart the app. When it loads the extension plug-in script and reaches the `debugger;` line, the script will be interrupted. The process of starting the app will stop until the script completes.
...
6. Once connected, you can step through the extension script or add breakpoints as you would with any other debugging. Once the script completes, the test instance will be continue to start up.
